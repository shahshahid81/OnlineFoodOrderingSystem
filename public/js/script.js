...
function editOrder() {
  ...
  if (choice === false) {
    ...
    var statusElementString =
      "<select id='category' class='category' name='category' class='form-control input-lg'><option value= 'Pending' > Pending </option><option value= 'Accepted' > Accepted </option><option value= 'Rejected' > Rejected </option><option value= 'Dispatched' > Dispatched </option><option value= 'Delivered' > Delivered </option></select>";
    var buttonElementString =
      "<button class='icon' onclick='changeStatus()'><i class='fa fa-check'></i></button>";
  ...
  if (choice === false) {
    ...
    $.ajax({
      ...
      success: function (status) {
        var buttonElementString =
          "<button class='icon' onclick='editOrder()'><i class='fa fa-pencil'></i></button>";
